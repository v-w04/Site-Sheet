  ...
  ui.createMenu('SITE SHEET')
    ...
    .addSubMenu(
      ui.createMenu('🏬 Walmart')
        ...
        .addSeparator()
        .addItem('🔍 Revisar Concentrado', 'revisarConcentrado')
        .addItem('🔍 Revisar variantes', 'revisarVariantes')
        .addSeparator()
        .addItem('📦 GTINs para convertir a WFS', 'wmGtinsParaConvertir')
        .addItem('🚫 Productos inactivos', 'wmProductosInactivos')
        .addItem('🧹 Publicaciones viejas a dar de baja', 'resParaDesactivar')
    )
    .addSubMenu(
      ui.createMenu('🏷 Cambio de precios')
        .addItem('🆕 Nuevo cambio', 'wmNuevoCambio')
        .addItem('📋 Pegar SKUs', 'wmPegarSkus')
        .addSeparator()
        .addItem('✅ Marcar lo filtrado', 'wmMarcarFiltrados')
        .addItem('🔤 Marcar por texto', 'wmMarcarPorTexto')
        .addItem('☑️ Marcar todo', 'wmMarcarTodo')
        .addItem('⬜ Desmarcar todo', 'wmDesmarcarTodo')
        .addSeparator()
        .addItem('✖️ Aplicar factor de precio', 'wmAplicarFactor')
        .addItem('📅 Aplicar fechas', 'wmAplicarFechas')
        .addItem('🔗 Asignar variante a mano', 'asignarVariante')
        .addSeparator()
        .addItem('📄 GENERAR ARCHIVO WALMART', 'wmGenerarArchivo')
    )
    .addSubMenu(
    ...
    .addSubMenu(
      ui.createMenu('⚙️ Configuración')
        ...
        .addItem('🏬 Conectar Walmart Dashboard', 'wmDashboardConectar')
    ...
    .addSeparator()
    .addItem('🧩 Rehacer hoja Inventarios', 'uiRehacerInventarios')
